  ...
  function t() {
    !(function () {
      ...
      S.forEach(function (t) {
		  //muda a quantidade do restante
        let r = g.stack(0, 0, 1, 3, 0, 0, function (r, i) {
          return (
            (r = p.random(0, e)),
            (i = p.random(0, n)),
            w.circle(
	  ...
	  //muda quantidade de aboboras
      let R = g.stack(0, 0, 7, 1, 0, 0, function (t, r) {
        return (
          (t = p.random(0, e)),
          (r = p.random(0, n)),
          w.circle(
